...
The files are split into:
  ...
  - n-body-simulator.ipynb: A Jupyter Ntebook containing both the simulation of the solar system and a modifiable n-body simulation created for educational purposes.
